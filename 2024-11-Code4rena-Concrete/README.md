...
| 15     | [M-09](#m-09)   | No way to remove rewardToken if added twice in `rewardTokens` array during initialization | [306](https://code4rena.com/evaluate/2024-11-concrete/submissions/S-306) | Rejected |
